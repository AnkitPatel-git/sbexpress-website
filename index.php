...
<html lang="en">
<head>
        <title>SB Express Cargo LLp Courier - Home</title>
       ...
       <!-- .header-wrapper end -->
            ...
            <div class="container">
                <div class="row services-negative-top">
                    <div class="col-md-4 col-sm-4">
                        <div class="service-feature-box">
                            <div class="service-media">
                                <img src="img/pics/img01.jpg" alt="SB Cargo"/>
                            ...
                            <div class="service-body">
                                ...
                                <p>
                                    SB Express Domestic Express offers reliable door to door solutions for time-critical packages to be delivered within a country or city. SB Express picks up and delivers your packages within agreed delivery times with the ability to track your shipments online at any time. 
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service-feature-box">
                            <div class="service-media">
                                <img src="img/pics/img02.jpg" alt="SB Cargo"/>
                            ...
                            <div class="service-body">
                                <div class="custom-heading">
                                    <h4>Logistic Solutions
</h4>
                                </div><!-- .custom-heading end -->

                                <p>
                                    Warehousing and Dispatches – We provide godown facilities and function as a logistic service provider for procurement, storage, processing, packaging and dispatch of goods as per customer needs, thus functioning as a one shop stop for all logistic solutions.
                    ...
                    <div class="col-md-4 col-sm-4">
                        <div class="service-feature-box">
                            <div class="service-media">
                                <img src="img/pics/img03.jpg" alt="SB Cargo"/>
                            ...
                            <div class="service-body">
                                <div class="custom-heading">
                                    <h4>International Express

</h4>
                                </div><!-- .custom-heading end -->

                                <p>
                                    SB Express provides a global solution for moving time-sensitive documents and parcels door-to-door around the world and within a variety of transit time options that will meet your every need.
                                </p>
                            </div><!-- .service-body end -->
                        </div><!-- .service-feature-box-end -->
                    </div><!-- .col-md-4 end -->
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="custom-heading02">
                            <h2>SB Express Cargo & Courier</h2>
                            <p> </p>
         ...
         <div class="page-content">
            <div class="container">
                <div class="row">
                    <div class="col-md-6">
                        <div class="custom-heading">
                            <h2>BEST COURIER SERVICE – WHAT IS IT?
</h2>
                        </div><!-- .custom-heading end -->

                        <p>
                            The fact is that the world ‘BEST’ involves a lot of things. Most of the consumers usually  have a very tough time to choose the best courier company which can meet their needs and deliver the product on time.
                ...
                <div class="row mb-30">
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            ...
                            <div class="service-details">
                                <h3>Why You Should Choose The SB Express Cargo Courier Company?

</h3>

                                <p>
                                    To put it simply, SB Express Cargo courier covers all the different kind of courier services and make sure that the customer gets the best value from their services. A reputed and established courier company can offer you with the most reliable, high-tech and customer focused services at a pocket-friendly price.
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            ...
                            <div class="service-details">
                                <h3>Technology Matters!
</h3>

                                <p>
                                    You can either look for domestic or international courier services according to your business needs. Always choose a company which focuses on customer-satisfaction. Nowadays, most of the big courier companies make use of the GPS tracking technology to make sure the customers with quick, efficient and high-quality services. So always look for a company which makes use of the latest technology and also charges an affordable price for the services.
                    ...
                    <div class="col-md-6 col-sm-6">
                        <div class="service-icon-left-boxed">
                            ...
                            <div class="service-details">
                                ...
                                <p>
                                    SB Express Cargo which specializes in both the domestic and international courier is the best company but if it's a reputed company, get ready to shell out a hefty amount for the services. Look at this website for more info:  www.sbexpresscargo.com
        ...
        <div class="page-content custom-bkg bkg-dark-blue column-img-bkg dark ">
            <div class="container-fluid">
                <div class="row">
                    <div class="col-md-5 col-md-offset-1 custom-col-padding-both">
                        <div class="custom-heading">
                            <h3>Our wide range of services
include</h3>
                        </div><!-- .custom-heading end -->
