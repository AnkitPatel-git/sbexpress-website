...
<title>Undelivered Web Bill  | SB Express Cargo LLp Courier </title>
 ...
 <?php include'include/menu.php'; ?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
       Undelivered Tracking Details
      </h1>
      <ol class="breadcrumb">
        <li><a href="dashboard.php"><i class="fa fa-dashboard"></i>Dashboard</a></li>
        <li class="active"> Undelivered Tracking Details</li>
      </ol>
    </section>
     ...
     <div class="box box-primary">
      ...
      <div class="box-body">
         <?php 
          ...
          <form action="undelivered-tracking-details.php" method="post">
          ...
          <table class="table table-bordered table-striped" data-sorting="true" data-filtering="true" data-paging="true" id="example1">
                    ...
                    <?php 
                      ...
                      if($showtd['Statu_Remarks'] == 'SHIPMENT DELIVERED' || $showtd['Statu_Remarks'] == 'DELIVERED' || $showtd['Statu_Remarks'] == 'delivered' || $showtd['Statu_Remarks'] == 'shipment delivered') { } else {
                       ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a date-toggle="tooltip" title="view" class="btn btn-xs btn-flat btn-primary" href="manage-tracking-details.php?id=<?php echo $show['Track_ID']; ?>&status=undelivered"><i style="padding-right: 10px;" class="fa fa-eye"></i>
