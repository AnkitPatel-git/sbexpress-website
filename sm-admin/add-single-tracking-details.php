...
<title>Add Tracking Details | SB Cargo Express</title>
    ...
    <div class="col-md-12">
     <div class="box box-primary">
      <div class="box-header with-border">
       ...
       <a href="<?php echo base64_decode($_GET['url']); ?>" class="btn btn-flat btn-xs btn-success pull-right">Back</a>
      </div>
      <div class="box-body">

        <form id="webform" method="post" action="ajax/Add/Add-Web-Bill.php" class="form-horizontal">

            <div class="form-group">
              <label class="control-label col-md-3">AWB No</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" value="<?php echo $_GET['id']; ?>" placeholder="AWB No" readonly="readonly" />
                  <input type="hidden" name="AWB_No" value="<?php echo $_GET['id']; ?>">
                </div>
            </div>
          ...
          <div class="form-group">
              <label class="control-label col-md-3">Date of Pick Up</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="Date_of_Pick_Up" placeholder="Date of Pick Up"  />
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Sender Department</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="Sender_Department" placeholder="Sender Department"  />
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">SB Ref No</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="SB_Ref_No" placeholder="SB Ref No"  />
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">L</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="L" placeholder="L"  />
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Delivery Date</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="Delivery_Date" placeholder="Delivery Date"  />
                </div>
            </div>
            ...
            <div class="form-group">
              <label class="control-label col-md-3">Statu Remarks</label>
                <div class="col-md-5">
                  <input type="text" class="form-control" name="Statu_Remarks" placeholder="Statu Remarks"  />
                </div>
            </div>
   ...
   $('#webform')
       ...
       AWB_No: {
        ...
        Date_of_Pick_Up : {
          validators: {
            notEmpty: {
              message: 'The date of pick up is Required'  
            }
          }
        },
       From_Location : {
          validators: {
            notEmpty: {
              message: 'The from location is Required'  
            }
          }
        },
        Destination : {
        ...
        Delivery_Time : {
          validators: {
            notEmpty: {
              message: 'The delivery time is Required'  
            }
          }
        },
        Statu_Remarks : {
          validators: {
            notEmpty: {
              message: 'The statu remarks time is Required'  
            }
          }
        },
      }
    ...
    $.ajax({
        ...
        success: function(result) {
          $('#webform button').html('Save');
          notr();
          setTimeout(function(){ window.location.href = '<?php echo base64_decode($_GET['url']); ?>'; }, 1200);
        }
    });
  });
