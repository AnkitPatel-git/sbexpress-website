    ...
    if (!is_touch_device()) {
        function set_static_header(position) {
            ...
            if (position > header_height) {
                $(".header-wrapper.header-transparent").addClass("solid-color").find('.header-style01 .main-nav').css('margin-top', '5px');
                $(".header-wrapper.header-transparent02").addClass("solid-color").find('.header-style01 .main-nav').css('margin-top', '5px');
            } else {
                $(".header-wrapper.header-transparent").removeClass("solid-color").find('.header-style01 .main-nav').css('margin-top', '0px');
                $(".header-wrapper.header-transparent02").removeClass("solid-color").find('.header-style01 .main-nav').css('margin-top', '0px');
            }
